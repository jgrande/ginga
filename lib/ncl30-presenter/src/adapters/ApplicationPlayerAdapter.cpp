...
#undef SAVE_KEY
			player::input::InputCallback fnc = boost::bind( &br::pucrio::telemidia::ginga::ncl::adapters::application::ApplicationPlayerAdapter::userEventReceived, this, _1, _2 );
...
void ApplicationPlayerAdapter::onEvent( player::event::evtType::type type, player::event::evtAction::type action, const std::string &parameter/*=""*/, const std::string &value/*=""*/) {

	if (type == player::event::evtType::attribution) {
